...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNextNotionNext', // 您的昵称 例如 tangly1024
  ...
  POSTS_PER_PAGE: process.env.NEXT_PUBLIC_POST_PER_PAGE ||1012, // post counts per page
